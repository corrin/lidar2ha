...
def test_a_room_swallowed_by_another_is_named_in_the_work_list():
    ...
    hallway = room_at("hallway", 0, 0, 6.0, 2.0)
    toilet = room_at("toilet", 1.0, 0.4, 1.2, 1.2)
...
def test_the_share_is_of_the_smaller_room_not_the_larger():
    ...
    hallway = room_at("hallway", 0, 0, 6.0, 3.0)
    toilet = room_at("toilet", 1.0, 0.4, 1.2, 1.2)
...
def test_rooms_that_merely_touch_are_not_reported():
    ...
    nothing."""
    left = room_at("left", 0, 0, 3.0, 3.0)
    right = room_at("right", 3.0, 0, 3.0, 3.0)
...
def test_a_seam_a_couple_of_centimetres_wide_is_not_reported():
    ...
    left = room_at("left", 0, 0, 3.0, 3.0)
    right = room_at("right", 2.97, 0, 3.0, 3.0)
...
def test_a_sliver_is_not_reported_however_buried_it_is():
    ...
    them."""
    room = room_at("room", 0, 0, 4.0, 4.0)
    chip = room_at("chip", 1.0, 1.0, 0.3, 0.2)
...
def test_a_partial_overlap_is_reported_with_the_area_a_person_can_check():
    ...
    hallway = room_at("hallway", 0, 0, 6.0, 3.0)
    kitchen = room_at("kitchen", 4.0, 0, 4.0, 3.0)
...
def test_the_worst_buried_room_is_reported_first():
    ...
    hallway = room_at("hallway", 0, 0, 10.0, 4.0)
    buried = room_at("buried", 1.0, 1.0, 1.0, 1.0)
    clipped = room_at("clipped", 8.0, 3.5, 3.0, 3.0)
